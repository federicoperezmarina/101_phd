...
Te voy a dar la información contenida en https://dragonball-api.com/ en formato json
{
  "items": [
    {
      "id": 1,
  ...
  "links": {
    "first": "https://dragonball-api.com/api/characters?limit=58",
    "previous": "",
    "next": "",
    "last": "https://dragonball-api.com/api/characters?page=1&limit=58"
  }
}
...
Paso 1: Piensa en al menos 5 personajes populares. Sugerencias: Goku, Vegeta.
...
Paso 3: Organiza los datos en una matriz JSON limpia. Cada personaje debe ser un objeto independiente con todos los campos id, name, power_level_ki, max_power_level_ki, race, gender, description, image_url.
